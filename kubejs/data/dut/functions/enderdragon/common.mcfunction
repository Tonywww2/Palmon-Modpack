#血量
title @a[distance=..128] actionbar [{"text": "末影龙血量：","color": "gold","italic": false},{"score":{"name":"@s","objective":"dut_hp"},"color": "green","italic": false}]
...
scoreboard players set @s dut_count 400
...
execute store result score @s dut_count run execute if entity @a[distance=..128]
scoreboard players set @s dut_count1 4
...
execute as @s[scores={dut_phase=2}] run particle end_rod ^-4.4 ^2 ^1 0.05 0.05 0.05 0.05 1 force
#死亡9
execute as @s[scores={dut_phase=9}] run particle end_rod ^4.4 ^2 ^1 0.05 0.05 0.05 0.05 1 force
execute as @s[scores={dut_phase=9}] run particle end_rod ^-4.4 ^2 ^1 0.05 0.05 0.05 0.05 1 force
#停在上方3.5.6.7
#起飞4
