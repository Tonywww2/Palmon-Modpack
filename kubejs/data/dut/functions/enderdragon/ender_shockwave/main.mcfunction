...
execute as @e[distance=..4.5,type=!end_crystal] run damage @s 24 dragon_breath by @e[tag=dut_dragon,limit=1]
execute as @e[distance=..7,type=!end_crystal] run damage @s 16 dragon_breath by @e[tag=dut_dragon,limit=1]
