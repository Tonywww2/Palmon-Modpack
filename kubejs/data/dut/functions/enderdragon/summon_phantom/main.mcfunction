...
spreadplayers 0 0 6 48 false @e[tag=dut_summon_phantom]
...
execute at @e[tag=dut_summon_phantom,scores={dut_count=..3}] positioned ~ ~6 ~ run summon phantom ~ ~ ~ {Tags:["dut_phantom","dut_phantom0","dut_bydragon"],DeathLootTable:"dut:none"}
execute at @e[tag=dut_summon_phantom,scores={dut_count=..3}] positioned ~ ~6 ~ run playsound entity.evoker.prepare_summon voice @a ~ ~ ~ 0.6
execute at @e[tag=dut_summon_phantom,scores={dut_count=..3}] positioned ~ ~6 ~ run particle soul_fire_flame ~ ~ ~ 1.5 1.5 1.5 0.01 48 force
execute at @e[tag=dut_summon_phantom,scores={dut_count=..3}] positioned ~ ~6 ~ summon marker run function dut:enderdragon/ender_shockwave/particle
