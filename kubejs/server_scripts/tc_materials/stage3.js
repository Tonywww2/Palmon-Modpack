...
function stage3Materials(createMaterialBuilder, registerMaterialProcess) {
    ...
    // 辉铋
    db = 900;
    let bismuthinite = createMaterialBuilder('bismuthinite')
        .setCraftable(false).setSortOrder(sortOrder++).setTier(2).setNamespace("tinkers_advanced")
        .addStats()
        .addHead(db, 45.0, 12.0, 'minecraft:diamond')
        .addHandle(0.3, 0.6, 0.15, 0.3)
        .addPlatingHelmet(8.0, db * 0.7, 0.1, 1.0)
        .addPlatingChestplate(12.0, db * 1.0, 0.1, 1.0)
        .addPlatingLeggings(11.0, db * 0.9, 0.1, 1.0)
        .addPlatingBoots(6.0, db * 0.6, 0.1, 1.0)
        ...
        .addDefaultTrait(1, 'tinkers_advanced:fragile')
        .addPerStatTrait('tconstruct:armor', 1, 'tconstruct:revenge')
        .addPerStatTrait('tconstruct:armor', 1, 'tinkers_advanced:fragile')
        .build();
    ...
    let osmium = createMaterialBuilder('osmium')
        .setCraftable(false).setSortOrder(sortOrder++).setTier(2)
        .addStats()
        .addHead(db, 53.0, 14.0, 'minecraft:diamond')
        .addHandle(0.5, 0.6, 0.0, 0.2)
        .addPlatingHelmet(9.0, db * 0.7, 0.1, 1.0)
        .addPlatingChestplate(14.0, db * 1.0, 0.1, 1.0)
        .addPlatingLeggings(12.0, db * 0.9, 0.1, 1.0)
        .addPlatingBoots(7.0, db * 0.6, 0.1, 1.0)
        .addPlatingShield(db * 0.9, 0.1, 1.0)
        .addBinding()
        .addMaille()
        .addShieldCore()
        ...
        .addDefaultTrait(1, 'tinkers_things:dense')
        .addPerStatTrait('tconstruct:armor', 1, 'tcintegrations:poseidon')
        .addPerStatTrait('tconstruct:armor', 1, 'tcintegrations:dense')
        .build();
