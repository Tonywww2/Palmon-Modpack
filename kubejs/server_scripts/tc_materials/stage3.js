...
function stage3Materials(createMaterialBuilder, registerMaterialProcess) {
    ...
    let gamma_framework = createMaterialBuilder('gamma_framework')
        .setCraftable(true).setSortOrder(sortOrder++).setTier(2)
        .addStats()
        .addHead(db, 145.0, 14.0, 'minecraft:netherite')
        .addHandle(0.3, 0.8, 0.1, 0.3)
        .addPlatingHelmet(12.0, db * 0.7, 0.1, 3.0)
        .addPlatingChestplate(19.0, db * 1.0, 0.1, 3.0)
        .addPlatingLeggings(17.0, db * 0.9, 0.1, 3.0)
        .addPlatingBoots(10.0, db * 0.6, 0.1, 3.0)
        .addPlatingShield(db * 0.9, 0.1, 3.0)
        .addBinding()
        .addMaille()
