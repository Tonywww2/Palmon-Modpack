...
function stage5Materials(createMaterialBuilder, registerMaterialProcess) {
    ...
    let epsilon_framework = createMaterialBuilder('epsilon_framework')
        ...
        .addPlatingHelmet(17.0, db * 0.7, 0.2, 10.0)
        .addPlatingChestplate(28.0, db * 1.0, 0.2, 10.0)
        .addPlatingLeggings(25.0, db * 0.9, 0.2, 10.0)
        .addPlatingBoots(14.0, db * 0.6, 0.2, 10.0)
        .addPlatingShield(db * 0.9, 0.2, 10.0)
        .addBinding()
        .addMaille()
        .addTraits()
