function basicMaterials(createMaterialBuilder, registerMaterialProcess) {
    ...
    db = 800
    let osmium = createMaterialBuilder('osmium')
        .setCraftable(false).setSortOrder(sortOrder++).setTier(2)
        .addStats()
        .addHead(db, 48.0, 9.0, 'minecraft:diamond')
        .addHandle(0.4, 0.4, 0, 0)
        .addPlatingHelmet(6.0, db * 0.7, 0.05, 1.0)
        .addPlatingChestplate(9.0, db * 1.0, 0.05, 1.0)
        .addPlatingLeggings(8.0, db * 0.9, 0.05, 1.0)
        .addPlatingBoots(5.0, db * 0.6, 0.05, 1.0)
    ...
    db = 600
    let plated_slimewood = createMaterialBuilder('plated_slimewood')
        .setCraftable(false).setSortOrder(sortOrder++).setTier(2)
        .addStats()
        .addHead(db, 52.0, 8.0, 'minecraft:diamond')
        .addHandle(0, 0.3, 0, -0.2)
        .addPlatingHelmet(7.0, db * 0.7, 0.05, 1.0)
        .addPlatingChestplate(9.0, db * 1.0, 0.05, 1.0)
        .addPlatingLeggings(9.0, db * 0.9, 0.05, 1.0)
        .addPlatingBoots(5.0, db * 0.6, 0.05, 1.0)
        .addPlatingShield(db * 0.9, 0.05, 1.0)
        .addBinding()
        .addMaille()
    ...
    db = 700
    let queens_slime = createMaterialBuilder('queens_slime')
        .setCraftable(false).setSortOrder(sortOrder++).setTier(2)
        .addStats()
        .addHead(db, 58.0, 12.0, 'minecraft:diamond')
        .addHandle(0.2, 0.55, 0.2, 0.3)
    ...
    db = 700
    let hepatizon = createMaterialBuilder('hepatizon')
        .setCraftable(false).setSortOrder(sortOrder++).setTier(2)
        .addStats()
        .addHead(db, 64.0, 14.0, 'minecraft:diamond')
        .addHandle(0.3, 0.4, 0.4, 0.4)
        .addPlatingHelmet(7.0, db * 0.7, 0.05, 2.0)
        .addPlatingChestplate(11.0, db * 1.0, 0.05, 2.0)
        .addPlatingLeggings(10.0, db * 0.9, 0.05, 2.0)
        .addPlatingBoots(6.0, db * 0.6, 0.05, 2.0)
    ...
    db = 850
    let pink_slime_metal = createMaterialBuilder('pink_slime_metal')
        .setCraftable(false).setSortOrder(sortOrder++).setTier(3).setNamespace("tinkers_advanced")
        .addStats()
        .addHead(db, 115.0, 12.0, 'minecraft:diamond')
        .addHandle(0.2, 0.6, 0.1, 0.2)
        .addPlatingHelmet(9.0, db * 0.7, 0.05, 5.0)
        .addPlatingChestplate(14.0, db * 1.0, 0.05, 5.0)
        .addPlatingLeggings(12.0, db * 0.9, 0.05, 5.0)
        .addPlatingBoots(7.0, db * 0.6, 0.05, 5.0)
        .addPlatingShield(db * 0.9, 0.05, 5.0)
        .addBinding()
        .addMaille()
        .build()

    db = 850
    let nutritive_slime = createMaterialBuilder('nutritive_slime')
        .setCraftable(false).setSortOrder(sortOrder++).setTier(5).setNamespace("tinkers_advanced")
        .addStats()
        .addHead(db, 420.0, 21.0, 'minecraft:diamond')
        .addHandle(0.2, 1.1, 0.2, 0.2)
        .addPlatingHelmet(18.0, db * 0.7, 0.25, 11.0)
        .addPlatingChestplate(27.0, db * 1.0, 0.25, 11.0)
        .addPlatingLeggings(24.0, db * 0.9, 0.25, 11.0)
        .addPlatingBoots(15.0, db * 0.6, 0.25, 11.0)
