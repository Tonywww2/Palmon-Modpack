...
function stage2Materials(createMaterialBuilder, registerMaterialProcess) {
    ...
    let beta_framework = createMaterialBuilder('beta_framework')
        ...
        .addPlatingHelmet(9.0, db * 0.7, 0.05, 2.0)
        .addPlatingChestplate(14.0, db * 1.0, 0.05, 2.0)
        .addPlatingLeggings(12.0, db * 0.9, 0.05, 2.0)
        .addPlatingBoots(7.0, db * 0.6, 0.05, 2.0)
        .addBinding()
        .addMaille()
        .addShieldCore()
        .addTraits()
